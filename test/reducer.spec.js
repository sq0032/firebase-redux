...
describe('App', () => {
  describe('PLAN', () => {
    describe('User can set number of outputs in order to pass data to other players', () => {
      let state = null;
      beforeEach(() => {
      ...
      it('should increase number of outputs', () => {
      ...
      it('should remove outputs when decrease the number', () => {
  ...
  describe('DO', () => {
    ...
    describe('ADD_VARIABLE', () => {
      ...
      it('should handle adding a question variable', () => {
        ...
        console.log(state.sections[0].decleared_variables);
