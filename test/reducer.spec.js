  ...
  describe('sections', () => {
    ...
    describe('ADD_VARIABLE', () => {
      ...
      it('should handle adding a question variable', () => {
        ...
        state = game(state, actions.addVariable(0, 2, 'question'));
        ...
        state = game(state, actions.addVariable(0, 5, 'question'));
      ...
      xit('should handle adding/selecting an operation variable', () => {
